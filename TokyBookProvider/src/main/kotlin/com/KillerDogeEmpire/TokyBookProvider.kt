...
class TokyBookProvider : MainAPI() { // all providers must be an instance of MainAPI
    ...
    override suspend fun load(url: String): LoadResponse? {
        ...
        return if (tvType == TvType.TvSeries) {
            ...
            for (i in jason) { // (key,value)
                ...
                var name = i?.name ?: "Error" // eps?.title

                val href = "https://files01.tokybook.com/audio/" + i?.audiocode ?: "null"
